...
// Referensi https://www.youtube.com/watch?v=Jo6Mtq7zkkg
// ini sementara, data data ini hardcoded into the app
// dont hardcode data into a real app

class DataSource{

    companion object{

        fun createDataSet(): ArrayList<ReviewPost>{
            val list = ArrayList<ReviewPost>()
            list.add(
                ReviewPost(
                    "Congratulations!",
